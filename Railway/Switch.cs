...
namespace Benchmark.Railway
{
    ...
    public partial class Switch : TrackElement, ISwitch, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(Benchmark.Railway.Switch.ClassInstance)).Resolve("currentPosition")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(Benchmark.Railway.Switch.ClassInstance)).Resolve("positions")));
        }
