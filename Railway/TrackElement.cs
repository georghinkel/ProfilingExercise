...
namespace Benchmark.Railway
{
    ...
    public abstract partial class TrackElement : RailwayElement, ITrackElement, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(Benchmark.Railway.TrackElement.ClassInstance)).Resolve("sensor")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(Benchmark.Railway.TrackElement.ClassInstance)).Resolve("connectsTo")));
        }
