...
namespace Benchmark.Railway
{
    ...
    public partial class RailwayContainer : ModelElement, IRailwayContainer, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(Benchmark.Railway.RailwayContainer.ClassInstance)).Resolve("invalids")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(Benchmark.Railway.RailwayContainer.ClassInstance)).Resolve("semaphores")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(Benchmark.Railway.RailwayContainer.ClassInstance)).Resolve("routes")));
        }
