...
namespace Benchmark.Railway
{
    ...
    public partial class SwitchPosition : RailwayElement, ISwitchPosition, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(Benchmark.Railway.SwitchPosition.ClassInstance)).Resolve("position")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(Benchmark.Railway.SwitchPosition.ClassInstance)).Resolve("switch")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(Benchmark.Railway.SwitchPosition.ClassInstance)).Resolve("route")));
        }
