...
namespace NMF.Expressions
{
    internal class GroupJoinExpression<TOuter, TInner, TKey, TResult> : IEnumerableExpression<TResult>
    {
        ...
        {
            PreCondition.AssertNotNull(() => outer);
            PreCondition.AssertNotNull(() => inner);
            PreCondition.AssertNotNull(() => outerKeySelector);
            PreCondition.AssertNotNull(() => innerKeySelector);
            PreCondition.AssertNotNull(() => resultSelector);
